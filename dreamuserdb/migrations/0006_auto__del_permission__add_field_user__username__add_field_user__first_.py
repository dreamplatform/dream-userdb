...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'User._username'
        db.add_column('dreamuserdb_user', '_username', self.gf('django.db.models.fields.CharField')(max_length=30, null=True), keep_default=False)

        # Adding field 'User._first_name'
        db.add_column('dreamuserdb_user', '_first_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True), keep_default=False)

        # Adding field 'User._last_name'
        db.add_column('dreamuserdb_user', '_last_name', self.gf('django.db.models.fields.CharField')(max_length=30, null=True), keep_default=False)

        # Adding field 'User._email'
        db.add_column('dreamuserdb_user', '_email', self.gf('django.db.models.fields.EmailField')(max_length=75, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'User._username'
        db.delete_column('dreamuserdb_user', '_username')

        # Deleting field 'User._first_name'
        db.delete_column('dreamuserdb_user', '_first_name')

        # Deleting field 'User._last_name'
        db.delete_column('dreamuserdb_user', '_last_name')

        # Deleting field 'User._email'
        db.delete_column('dreamuserdb_user', '_email')
