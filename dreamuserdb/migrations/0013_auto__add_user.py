...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field user_groups on 'User'
        db.create_table('dreamuserdb_user_user_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('user', models.ForeignKey(orm['dreamuserdb.user'], null=False)),
            ('group', models.ForeignKey(orm['dreamuserdb.group'], null=False))
        ))
        db.create_unique('dreamuserdb_user_user_groups', ['user_id', 'group_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field user_groups on 'User'
        db.delete_table('dreamuserdb_user_user_groups')
