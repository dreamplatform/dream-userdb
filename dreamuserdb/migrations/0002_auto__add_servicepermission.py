...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('dreamuserdb_servicepermission', (
        ...
        db.send_create_signal('dreamuserdb', ['ServicePermission'])

        # Adding M2M table for field srvpermissions on 'Role'
        db.create_table('dreamuserdb_role_srvpermissions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('role', models.ForeignKey(orm['dreamuserdb.role'], null=False)),
            ('servicepermission', models.ForeignKey(orm['dreamuserdb.servicepermission'], null=False))
        ))
        db.create_unique('dreamuserdb_role_srvpermissions', ['role_id', 'servicepermission_id'])


    def backwards(self, orm):
        
        # Deleting model 'ServicePermission'
        db.delete_table('dreamuserdb_servicepermission')

        # Removing M2M table for field srvpermissions on 'Role'
        db.delete_table('dreamuserdb_role_srvpermissions')
