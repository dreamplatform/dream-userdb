...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('dreamuserdb_role', 'srvpermission_id', 'permission_id')
        db.rename_table('dreamuserdb_role_srvpermissions', 'dreamuserdb_role_permissions')

    def backwards(self, orm):
        db.rename_column('dreamuserdb_role', 'permission_id', 'srvpermission_id')
        db.rename_table('dreamuserdb_role_permissions', 'dreamuserdb_role_srvpermissions')
