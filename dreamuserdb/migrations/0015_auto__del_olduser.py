...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'OldUser'
        db.delete_table('dreamuserdb_olduser')

        # Removing M2M table for field organisations on 'OldUser'
        db.delete_table('dreamuserdb_olduser_organisations')

        # Removing M2M table for field groups on 'OldUser'
        db.delete_table('dreamuserdb_olduser_groups')

        # Removing M2M table for field roles on 'OldUser'
        db.delete_table('dreamuserdb_olduser_roles')


    def backwards(self, orm):
        
        # Adding model 'OldUser'
        db.create_table('dreamuserdb_olduser', (
        ...
        db.send_create_signal('dreamuserdb', ['OldUser'])

        # Adding M2M table for field organisations on 'OldUser'
        db.create_table('dreamuserdb_olduser_organisations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('olduser', models.ForeignKey(orm['dreamuserdb.olduser'], null=False)),
            ('organisation', models.ForeignKey(orm['dreamuserdb.organisation'], null=False))
        ))
        db.create_unique('dreamuserdb_olduser_organisations', ['olduser_id', 'organisation_id'])

        # Adding M2M table for field groups on 'OldUser'
        db.create_table('dreamuserdb_olduser_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('olduser', models.ForeignKey(orm['dreamuserdb.olduser'], null=False)),
            ('group', models.ForeignKey(orm['dreamuserdb.group'], null=False))
        ))
        db.create_unique('dreamuserdb_olduser_groups', ['olduser_id', 'group_id'])

        # Adding M2M table for field roles on 'OldUser'
        db.create_table('dreamuserdb_olduser_roles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('olduser', models.ForeignKey(orm['dreamuserdb.olduser'], null=False)),
            ('role', models.ForeignKey(orm['dreamuserdb.role'], null=False))
        ))
        db.create_unique('dreamuserdb_olduser_roles', ['olduser_id', 'role_id'])
