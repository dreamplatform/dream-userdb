...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.official'
        db.add_column('dreamuserdb_group', 'official', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Role.official'
        db.add_column('dreamuserdb_role', 'official', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.official'
        db.delete_column('dreamuserdb_group', 'official')

        # Deleting field 'Role.official'
        db.delete_column('dreamuserdb_role', 'official')
